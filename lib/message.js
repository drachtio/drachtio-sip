...
function SipMessage(msg) {
 ...
 var self = this ;
  ...
  Object.defineProperty( this, 'callingNumber', {
    get: function() {
      var callingNumber ;
      var header = this.has('p-preferred-identity') ? this.get('p-preferred-identity') : this.get('from') ;
...
/*
SipMessage.prototype.getParsed = function( hdr ) {
  return this.headers[hdr].parsed ;
} ;
*/
